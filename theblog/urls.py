...
urlpatterns = [
    ...
    path('blogTransversal/', TestBlogTransversalHomeView.as_view(), name="BlogTransversal_list"),
    path('blogTransversal/entradas/', TestBlogTransversalListView.as_view(), name="BlogTransversal_entradas"),
    ...
    path('blogTransversal/<int:pk>/', TestBlogTransversalDetailView.as_view(), name="BlogTransversal-detail"),
